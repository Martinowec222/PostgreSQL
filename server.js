...
async function renderClientDashboardBody(clientId, clientName, exportHref) {
  ...
  return `
    ...
    <div class="card">
      ...
      <table style="margin-top:12px;">
        <thead><tr><th>Kartička</th><th>Kód</th><th>Skeny celkem</th><th>Za 7 dní</th></tr></thead>
        <tbody>${cardRows || '<tr><td colspan="4">Zatím žádné kartičky.</td></tr>'}</tbody>
      </table>
    </div>
